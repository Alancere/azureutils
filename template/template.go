...
*/
func ParseTemplates(templateDir, outputDir string, data any, funcMap template.FuncMap) error {
	...
	for _, t := range tpl.Templates() {
		...
		w, err := os.OpenFile(filepath.Join(outputDir, fName), os.O_CREATE|os.O_TRUNC|os.O_WRONLY, 0o666)
		if err != nil {
			return err
		}
		defer w.Close()
